...
A description of the provided fleets and results is available in the file 'data_description.pdf'.

The new instances were genereated by choosing random subsets of customers from the VRPSDPTW benchmark instances with 100 customers Solomon (1987), which were adapted by Wang (2012), available at https://oz.nthu.edu.tw/~d933810/test.htm.
